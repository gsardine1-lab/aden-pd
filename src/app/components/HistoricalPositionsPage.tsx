              ...
              <table className="w-full min-w-[1000px] text-xs">
                <thead>
                  <tr className="bg-[#F9FAFB] border-b border-[#F3F4F6]">
                    ...
                    <th className="text-right px-3 py-2.5 text-[11px] font-semibold text-[#374151] whitespace-nowrap cursor-pointer hover:bg-[#F3F4F6] select-none" onClick={() => handleSort('notionalCNY')}>本次平仓名本{renderSortArrow('notionalCNY')}</th>
