...
export const mockPositions: Position[] = [
  ...
  { id: '11', underlying: '美团', code: '3690.HK', market: '港股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-02-15', expiryDate: '2026-06-15', term: '4个月', notionalCNY: 6500000, openNotionalCNY: 6500000, optionQty: 38690,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整且提前行权扣分红' },
  ...
  { id: '12', underlying: '阿里巴巴', code: '9988.HK', market: '港股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-03-10', expiryDate: '2026-07-10', term: '4个月', notionalCNY: 8800000, openNotionalCNY: 8800000, optionQty: 89796,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
  ...
  { id: '13', underlying: '小米集团', code: '1810.HK', market: '港股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-01-20', expiryDate: '2026-05-28', term: '4个月', notionalCNY: 5200000, openNotionalCNY: 5200000, optionQty: 179310,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
  ...
  { id: '16', underlying: '英伟达', code: 'NVDA', market: '美股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '110%Call', startDate: '2026-02-28', expiryDate: '2026-05-30', term: '3个月', notionalCNY: 16000000, openNotionalCNY: 16000000, optionQty: 15311,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自动行权（标准行权）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '17', underlying: '亚马逊', code: 'AMZN', market: '美股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-03-15', expiryDate: '2026-06-20', term: '3个月', notionalCNY: 12000000, openNotionalCNY: 12000000, optionQty: 61856,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自動行权（标准行权）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
  ...
  // === 近7天集中到期的 mock 数据 ===
  { id: '19', underlying: '比亚迪', code: '002594.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-02-20', expiryDate: '2026-05-20', term: '3个月', notionalCNY: 9000000, openNotionalCNY: 9000000, optionQty: 29032,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '20', underlying: '药明康德', code: '603259.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-03-01', expiryDate: '2026-05-20', term: '3个月', notionalCNY: 4500000, openNotionalCNY: 4500000, optionQty: 64286,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红不调整', negotiationPlan: '原合约维持，多承担1个板' },
    counterparty: '中信证券', counterpartyFullName: '中信证券股份有限公司', tags: [] },
  { id: '21', underlying: '阳光电源', code: '300274.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-03-10', expiryDate: '2026-05-20', term: '2个月', notionalCNY: 3200000, openNotionalCNY: 3200000, optionQty: 28070,
  ...
  { id: '22', underlying: '海康威视', code: '002415.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '110%Call', startDate: '2026-03-15', expiryDate: '2026-05-20', term: '2个月', notionalCNY: 2800000, openNotionalCNY: 2800000, optionQty: 37333,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
    counterparty: '银河证券', counterpartyFullName: '中国银河证券股份有限公司', tags: [] },
  { id: '23', underlying: '爱尔眼科', code: '300015.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-04-01', expiryDate: '2026-05-20', term: '2个月', notionalCNY: 2100000, openNotionalCNY: 2100000, optionQty: 52500,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红调整', negotiationPlan: '原合约维持，多承担1个板' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '24', underlying: '美团', code: '3690.HK', market: '港股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-04-05', expiryDate: '2026-05-22', term: '1.5个月', notionalCNY: 7800000, openNotionalCNY: 7800000, optionQty: 46429,
    ...
    tradingRules: { exerciseRule: '到期日 T+1 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '25', underlying: '快手', code: '1024.HK', market: '港股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-04-08', expiryDate: '2026-05-22', term: '1.5个月', notionalCNY: 5600000, openNotionalCNY: 5600000, optionQty: 90323,
  ...
  { id: '26', underlying: '中芯国际', code: '688981.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-04-10', expiryDate: '2026-05-22', term: '1.5个月', notionalCNY: 4100000, openNotionalCNY: 4100000, optionQty: 68333,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红调整', negotiationPlan: '原合约维持，多承担1个板' },
    counterparty: '招商证券', counterpartyFullName: '招商证券股份有限公司', tags: [] },
  { id: '27', underlying: '中国中免', code: '601888.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-05-05', expiryDate: '2026-05-19', term: '0.5个月', notionalCNY: 3500000, openNotionalCNY: 3500000, optionQty: 35000,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '28', underlying: '东方财富', code: '300059.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-05-06', expiryDate: '2026-05-19', term: '0.5个月', notionalCNY: 2800000, openNotionalCNY: 2800000, optionQty: 93333,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
    counterparty: '海通证券', counterpartyFullName: '海通证券股份有限公司', tags: [] },
  { id: '29', underlying: '韦尔股份', code: '603501.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-05-08', expiryDate: '2026-05-18', term: '10天', notionalCNY: 1800000, openNotionalCNY: 1800000, optionQty: 25714,
  ...
  { id: '30', underlying: '汇川技术', code: '300124.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-05-11', expiryDate: '2026-05-18', term: '7天', notionalCNY: 1500000, openNotionalCNY: 1500000, optionQty: 30000,
  ...
  { id: '31', underlying: '恒瑞医药', code: '600276.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-03-20', expiryDate: '2026-05-20', term: '2个月', notionalCNY: 6800000, openNotionalCNY: 6800000, optionQty: 136000,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
  { id: '32', underlying: '中兴通讯', code: '000063.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-04-01', expiryDate: '2026-05-20', term: '1.5个月', notionalCNY: 3600000, openNotionalCNY: 3600000, optionQty: 102857,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红不调整', negotiationPlan: '原合约维持' },
    counterparty: '海通证券', counterpartyFullName: '海通证券股份有限公司', tags: [] },
  { id: '33', underlying: '紫金矿业', code: '601899.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-04-05', expiryDate: '2026-05-20', term: '1.5个月', notionalCNY: 4200000, openNotionalCNY: 4200000, optionQty: 93333,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '华泰证券', counterpartyFullName: '华泰证券股份有限公司', tags: [] },
  { id: '34', underlying: '迈瑞医疗', code: '300760.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '110%Call', startDate: '2026-04-10', expiryDate: '2026-05-20', term: '1.5个月', notionalCNY: 5500000, openNotionalCNY: 5500000, optionQty: 61111,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红调整', negotiationPlan: '原合约维持，多承担1个板' },
    counterparty: '中金公司', counterpartyFullName: '中国国际金融股份有限公司', tags: [] },
  { id: '35', underlying: '青岛啤酒', code: '600600.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-04-15', expiryDate: '2026-05-20', term: '1个月', notionalCNY: 2400000, openNotionalCNY: 2400000, optionQty: 40000,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红不调整' },
    counterparty: '招商证券', counterpartyFullName: '招商证券股份有限公司', tags: [] },
  { id: '36', underlying: '上汽集团', code: '600104.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '103%Call', startDate: '2026-04-18', expiryDate: '2026-05-20', term: '1个月', notionalCNY: 3100000, openNotionalCNY: 3100000, optionQty: 50000,
    ...
    counterparty: '广发证券', counterpartyFullName: '广发证券股份有限公司', tags: [] },
  // 5/26 集中到期补充
  { id: '37', underlying: '格力电器', code: '000651.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-05-01', expiryDate: '2026-05-26', term: '3周', notionalCNY: 2000000, openNotionalCNY: 2000000, optionQty: 50000,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '2连板强制敲出', dividendRule: '分红调整' },
    counterparty: '银河证券', counterpartyFullName: '中国银河证券股份有限公司', tags: [] },
  { id: '38', underlying: '福耀玻璃', code: '600660.SH', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '105%Call', startDate: '2026-05-05', expiryDate: '2026-05-26', term: '3周', notionalCNY: 1800000, openNotionalCNY: 1800000, optionQty: 45000,
  ...
  { id: '39', underlying: '顺丰控股', code: '002352.SZ', market: 'A股', strategy: '香草看涨期权', operation: '买入', optionType: 'Call', tradeType: '看涨期权', structure: '100%Call', startDate: '2026-05-08', expiryDate: '2026-05-26', term: '2.5周', notionalCNY: 2600000, openNotionalCNY: 2600000, optionQty: 52000,
    ...
    tradingRules: { exerciseRule: '到期日 T+5 行权', expiryRule: '到期日自动行权（盈利时）', knockoutRule: '3连板协商敲出', dividendRule: '分红调整', negotiationPlan: '原合约维持' },
    counterparty: '亚丁', counterpartyFullName: '亚丁资本管理有限公司', tags: [] },
];
